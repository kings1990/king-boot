...
public class UserApi {
    ...
    @PutMapping (value = "/{accountId}",name = "api测试",consumes = MediaType.APPLICATION_FORM_URLENCODED_VALUE)
    ...
    @DeleteMapping (value = "/{id}",name = "api测试")
    @ApiOperation(value = "根据用户id删除",notes = "根据用户id删除(0-失败 1-成功)【Kings】")
    public RestResponse<Integer> deleteUser(@PathVariable @ApiParam("用户id") Integer accountId) {
        return new RestResponse<>(1);
    }
}
