  ...
  !function (e, t) {
    ...
    n("moxie/core/utils/Basic", [], function () {
      ...
      var e = function (e) {
        ...
        var n, r, o, a, s, u, c, l, d = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", m = 0,
          h = 0, f = "", p = [];
        if (!e) return e;
        e += "";
      ...
      function t(e, t, i) {
        var n = 0, r = 0, o = 0, a = {dev: -6, alpha: -5, a: -5, beta: -4, b: -4, RC: -3, rc: -3, "#": -2, p: 1, pl: 1},
          s = function (e) {
      ...
      function h() {
        ...
        var x, v, y, w, E, b, R, _, A = this, I = {
            ...
            responseText: null,
            response: null
          }, T = !0, S = {}, O = null, D = null, N = !1, C = !1, L = !1, M = !1, F = !1, B = !1, P = null, H = null,
          k = {}, U = "";
        e.extend(this, I, {
          uid: e.guid("uid_"), upload: new m, open: function (o, a, s, u, c) {
            ...
            return t = t.toLowerCase(), F || ~e.inArray(t, ["set-cookie", "set-cookie2"]) ? null : U && "" !== U && (_ || (_ = {}, e.each(U.split(/\r\n/), function (t) {
              var i = t.split(/:\s+/);
              2 === i.length && (i[0] = e.trim(i[0]), _[i[0].toLowerCase()] = {header: i[0], value: e.trim(i[1])})
      ...
      function h() {
        ...
        a.call(this), e.extend(this, {
          ...
          embed: function (n, r) {
            ...
            var a, c = this,
              l = e.extend({width: this.width, height: this.height, type: this.type || "image/jpeg", quality: 90}, r);
            try {
      ...
      function s() {
        ...
        i.extend(this, {
          init: function (u) {
            ...
            var t = this.getRuntime(), i = t.getShim(), o = t.getShimContainer(), a = e && n.get(e.container),
