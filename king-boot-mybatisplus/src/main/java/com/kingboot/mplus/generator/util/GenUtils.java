package com.kingboot.mplus.generator.util;
...
import com.kingboot.mplus.generator.entity.ColumnEntity;
import com.kingboot.mplus.generator.entity.GenConfig;
import com.kingboot.mplus.generator.entity.TableEntity;
import com.kingboot.mplus.generator.exception.CheckedException;
...
public class GenUtils {
	...
	private String getFileName(String template, String className, String packageName, String moduleName) {
		...
		if (template.contains(CONTROLLER_JAVA_VM)) {
			return packagePath + "controller" + File.separator + className + "Api.java";
		}
